...
public class Lavadora extends Applet{
    ...
    private BranchGroup crearEscenarioGrafico(){
        ...
        TextureLoader archivo = new TextureLoader("src/images/Fondo_Lavadora.jpg",this);
    ...
    private BranchGroup modelarObjeto(){
        ...
        transformacion3d.setTranslation(new Vector3d(2.9,-3.8,-28)); //define posicion del objeto
        ...
        producto.addChild(cargarObjeto("src\\images\\BOSCH WLG.obj"));
        
        Alpha alpha = new Alpha(-1,20000);
        
        Transform3D eje = new Transform3D();
        eje.setRotation(new AxisAngle4f(1.3f,8.0f,0.0f,20.0f));
    ...
    public static void main (String[] args){
        Lavadora ejecutar = new Lavadora();
