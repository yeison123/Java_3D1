...
public class Bisicleta extends Applet{
    ...
    private BranchGroup crearEscenarioGrafico(){
        ...
        TextureLoader archivo = new TextureLoader("src/images/Fondo_Bisicleta.jpg",this);
    ...
    private BranchGroup modelarObjeto(){
        ...
        transformacion3d.setTranslation(new Vector3d(0.3,-0.15,-2)); //define posicion del objeto
        transformacion3d.setScale(0.01); //define el tamaño del objeto
        ...
        producto.addChild(cargarObjeto("src\\images\\11717_bicycle_v2_L1.obj"));
        
        Alpha alpha = new Alpha(-1,20000);
        
        Transform3D eje = new Transform3D();
        eje.setRotation(new AxisAngle4f(8.3f,8.0f,8.0f,20.0f));
    ...
    private Light iluminar(){
        DirectionalLight luz = new DirectionalLight(true,new Color3f(2.0f,1.0f,0.0f),new Vector3f(-2.0f,3.0f,-2.0f));
    ...
    public static void main (String[] args){
        Bisicleta ejecutar = new Bisicleta();
