...
public final class Silla extends Applet {
    private static final long serialVersionUID = 1L;
    
    public static void main(String[] args){
        if (args.length>=1)
            new MainFrame(new Silla(args[1]),850,600);
        else
            new MainFrame(new Silla(null),850,600);
    }
    
    public Silla (String filename){
        //se crea el universo
    ...
    public BranchGroup crearescenaG(String filename){
        ...
        Alpha rotacionAlpha = new Alpha(-1,Alpha.INCREASING_ENABLE,0,0,4000,0,2,0,2,0);
        ...
        ObjectFile file = new ObjectFile(flags,(float)(30.0*Math.PI/180.0));
        
         Scene s = null;
        
        try{
           s = file.load(filename == null ? "src\\images\\Cadeira.obj" : filename);
    ...
    private TransformGroup dibujarfondo(){
        ...
        TextureLoader espacio = new TextureLoader("src/images/Fondo_Silla.jpg",this);
